    ...
    def initialize_redundant_expert_weights(self):
        ...
        for layer_id in range(adaptor.num_moe_layers):
            for redundant_id in range(num_redundant_experts):
                ...
                # Bound startup-only P2P work to one expert. Submitting every
                # layer at once retains thousands of outstanding transfers
                # while the runtime is measuring its non-KV memory budget.
